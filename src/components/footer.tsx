      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-12 mb-8 sm:mb-12">
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-gray-400 leading-relaxed text-sm">
              Desarrollador Web y estudiante de Data Analytics.
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex gap-4 justify-center sm:justify-start">
              <a
                href="https://www.instagram.com/_dieggo.66/"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/diego-teran-021bb5262/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://github.com/DieguitoCoder"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="border-t border-gray-900 pt-6 sm:pt-8">
          <p className="text-gray-500 text-center text-xs sm:text-sm">
            © {new Date().getFullYear()} Dieguito. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
